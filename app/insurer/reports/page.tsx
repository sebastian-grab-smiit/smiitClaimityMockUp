        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-2xl font-bold text-gray-900 mb-2">Berichte & Rechnungen</h1>
                <p className="text-gray-600">Verwalten und exportieren Sie Ihre Berichte und Rechnungen</p>
              </div>
            </div>
