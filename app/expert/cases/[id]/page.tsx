...
export default function ExpertCaseDetailPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params) 
    ...
    messages: [
      {
        ...
        message: "Guten Tag, könnten Sie bitte eine Einschätzung der Reparaturkosten abgeben? Der Kunde fragt nach.",
        attachments: [],
      },
      {
        id: 2,
