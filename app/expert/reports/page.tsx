...
import { FileText, Upload, Download, Search, Plus, Eye, Edit, Clock, CheckCircle, AlertCircle, MessageSquare, Settings, BarChart3, Calendar, Timer } from "lucide-react"
    ...
    <div className="h-screen flex flex-col bg-slate-50">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-slate-800 mb-2">Berichte</h1>
            <p className="text-gray-600">Verwalten Sie Ihre Berichte</p>
          </div>

          {/* Tabs */}
          <div className="bg-white rounded-lg mb-6 rounded-xl border shadow-sm">
