...
import { ArrowLeft, ChevronLeft, ChevronRight, Plus, Clock, MapPin } from "lucide-react"
              ...
              <div className="grid grid-cols-7 gap-1">
                {days.map((day, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`text-sm font-medium mb-1 ${isToday ? "text-teal-700" : "text-slate-800"}`}>
                        {day}
                      </div>
