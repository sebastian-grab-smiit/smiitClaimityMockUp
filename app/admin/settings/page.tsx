          ...
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-gray-600">Alle Admin Einstellungen der Claimity Anwendung</p>
              </div>
            </div>
            ...
            <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as TabId)}  className="space-y-6">
              ...
              <div className="p-6">
                ...
                <TabsContent value="data" className="space-y-6">
                  <h1 className="text-2xl font-bold text-gray-900 mb-2">Daten & Backup</h1>
                ...
                <TabsContent value="security" className="space-y-6">
                  <h1 className="text-2xl font-bold text-gray-900 mb-2">Sicherheits-Einstellungen</h1>
