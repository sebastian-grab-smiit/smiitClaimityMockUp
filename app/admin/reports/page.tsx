  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto p-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-slate-800 mb-2">Berichte-Prüfung & Genehmigung</h1>
          <p className="text-slate-600">Überprüfung von Expertengutachten auf Vollständigkeit und Qualität</p>
        </div>
